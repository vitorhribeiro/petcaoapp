...
import { Clock, Lock, Dog, CalendarDays, CheckCircle2, ChevronRight, ChevronLeft, MapPin, Scissors, Plus, AlertCircle, MessageCircle } from 'lucide-react';
    ...
    <section id="agenda" className="py-24 scroll-mt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative group/agenda">
          <div className="absolute inset-x-0 -inset-y-4 z-40 backdrop-blur-md bg-background/40 flex items-center justify-center rounded-[2.5rem] border border-white/10 shadow-2xl">
            <div className="max-w-sm w-full mx-6 p-8 bg-card/90 backdrop-blur-xl border border-border/50 rounded-3xl shadow-2xl text-center space-y-5 animate-in fade-in zoom-in duration-500">
              <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-2 text-primary">
                <Lock className="w-8 h-8" />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-foreground">Agendamento em Breve</h3>
              ...
              <Button
                asChild
                size="lg"
                className="w-full bg-success hover:bg-success/90 text-white gap-2 h-12 rounded-xl text-base shadow-lg shadow-success/20"
              >
                <a
